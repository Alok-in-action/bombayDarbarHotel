// ============================================================
// BACKUP – original menu-data.ts (before complete replacement)
// Created: 2026-06-08
// ============================================================
...
export const menuData: MenuCategory[] = [
  ...
  // ── SANDWICHES ──────────────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      { name: 'Veg Cheese Grilled Sandwich', description: '', price: '80',  type: 'veg' },
    ],
  },
  {
    id: 'non_veg_sandwich',
  ...
  },
  {
    ...
    items: [
      { name: 'Hara Bhara Kabab',              description: 'Pea, Spinach & more', price: '200', type: 'veg' },
      { name: 'Veg Mayoneese Kabab',           description: '', price: '210', type: 'veg' },
      { name: 'Veg Pahadi Kabab',              description: '', price: '170', type: 'veg' },
      { name: 'Veg Spring Roll (Paneer)',       description: '', price: '180', type: 'veg' },
      { name: 'Veg Spring Roll (Noodles)',      description: '', price: '150', type: 'veg' },
  ...
  // ── NON-VEG STARTERS ─────────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      { name: 'Tandoori Leg Pcs',       description: '200 (3 pcs) / 370 (5 pcs)', price: '200', type: 'non-veg' },
  ...
  },
  {
    ...
    items: [
      { name: 'Chicken Breast',                description: '', price: '290', type: 'non-veg' },
      { name: 'Chicken Shami Kabab',           description: '', price: '240', type: 'non-veg' },
      { name: 'Chicken Chapli Kabab',          description: '', price: '220', type: 'non-veg' },
      { name: 'Chicken Cheese Kebab',          description: 'Half: ₹250 / Full: ₹470', price: '250', type: 'non-veg' },
      { name: 'Chicken Shahi Roll',            description: 'Half: ₹140 / Full: ₹280', price: '140', type: 'non-veg', popular: true },
      ...
      { name: 'Tandoori Schezwan Leg Piece',   description: 'Half: ₹220 / Full: ₹400', price: '220', type: 'non-veg' },
      ...
      { name: 'Chicken Tikka Dry (6 Pc)',      description: '', price: '200', type: 'non-veg' },
      { name: 'Chicken Makhmali Kebab (6 Pc)', description: '', price: '230', type: 'non-veg' },
      ...
      { name: 'Chicken Garlic Mayoneese',      description: '', price: '250', type: 'non-veg' },
      { name: 'Chicken Tiranga Roll',          description: '', price: '350', type: 'non-veg' },
      { name: 'Chicken Badami',                description: '', price: '300', type: 'non-veg' },
      { name: 'Chicken Popcorn',               description: '', price: '220', type: 'non-veg' },
      { name: 'Chicken Nargasi Kebab',         description: '', price: '380', type: 'non-veg' },
      { name: 'Chicken Mexican Sizzler',       description: '', price: '470', type: 'non-veg' },
    ],
  },
  ...
  // ── NON-VEG CHINESE NOODLES & RICE ──────────────────────────────────────────
  {
    ...
    items: [
      ...
      { name: 'Egg Schezwan Noodles',       description: '', price: '140', type: 'non-veg' },
    ],
  },
  {
  ...
  // ── NON-VEG MAIN COURSE ───────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      { name: 'Tawa Chicken (Boneless)',      description: '', price: '260', type: 'non-veg' },
      ...
      { name: 'Chicken Angara (Boneless)',    description: '', price: '300', type: 'non-veg' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Chicken Murgh Musallam', description: '₹660', price: '660', type: 'non-veg' },
    ],
  },
  // ── MUTTON ───────────────────────────────────────────────────────────────────
  {
  ...
  // ── FISH & PRAWNS ─────────────────────────────────────────────────────────────
  {
    ...
    name: 'Fish & Prawns',
    items: [
      { name: 'Fish Curry',       description: '4 pcs', price: '340', type: 'non-veg' },
      ...
      { name: 'Fish Tawa Fry',    description: '4 pcs', price: '380', type: 'non-veg' },
      { name: 'Fish Deep Fry',    description: '4 pcs', price: '480', type: 'non-veg' },
    ],
  },
  // ── BIRYANI (NON-VEG) ─────────────────────────────────────────────────────────
  {
    ...
    items: [
      { name: 'Chicken Dum Biryani',        description: '', price: '210', type: 'non-veg', popular: true },
      ...
      { name: 'Chicken Malai Biryani',      description: '', price: '250', type: 'non-veg' },
  ...
  // ── DESSERTS ─────────────────────────────────────────────────────────────────
  {
    ...
    name: 'Desserts',
    items: [
      { name: 'Gulab Jamun', description: 'Soft, spongy milk-based dumplings soaked in rose-flavored syrup', price: '', type: 'veg', popular: true },
    ],
  },
];
